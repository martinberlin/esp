...
// And on Step 2: #define OV5642_CAM
...
const int CS = 16;
// RESOLUCIONES: OV5642_640x480 OV5642_1280x960 OV5642_2048x1536 
int jpegSize = OV5642_640x480; 
// When timelapse is on will capture picture every N minutes
boolean captureTimeLapse;
boolean isStreaming = false;

const unsigned long timeLapse = 1 * 60 * 1000UL; // N minutes
...
// UPLOAD Settings
  ...
  String url = "/camera-uploads/upload.php?f=Tests";
